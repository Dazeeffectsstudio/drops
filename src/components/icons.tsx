...
export function GamepadIcon(props: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path d="M6 8.5h12a4 4 0 0 1 3.9 4.9l-.6 2.6a2.2 2.2 0 0 1-3.9 1L16 15H8l-1.4 2a2.2 2.2 0 0 1-3.9-1l-.6-2.6A4 4 0 0 1 6 8.5Z" /><path d="M7 9.5v4M5 11.5h4" /><circle cx="16.2" cy="10.6" r="0.9" /><circle cx="18.2" cy="12.6" r="0.9" /></svg>;
}

export function GemIcon(props: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path d="M4.5 9 8 4h8l3.5 5-7.5 11-7.5-11Z" /><path d="M4.5 9h15M8.5 4 7 9l5 11 5-11-1.5-5" /></svg>;
}

export function DropletIcon(props: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><path d="M12 3C8.5 7.5 6 11 6 14.5a6 6 0 0 0 12 0C18 11 15.5 7.5 12 3Z" /></svg>;
}

export function PuzzlePieceIcon(props: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><rect x="4" y="4" width="16" height="16" rx="4" /><path d="M12 8.5v7M8.5 12h7" /></svg>;
}

export function GiftIcon(props: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}><rect x="4" y="9" width="16" height="10" rx="1.5" /><path d="M4 13h16M12 9v10" /><path d="M8.7 9a2.3 2.3 0 1 1 0-4.6c2 0 3.3 2.1 3.3 4.6M15.3 9a2.3 2.3 0 1 0 0-4.6c-2 0-3.3 2.1-3.3 4.6" /></svg>;
}
