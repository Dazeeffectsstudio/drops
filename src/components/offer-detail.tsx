...
type Props = { offer: Offer; user: AuthUser | null; initialFavorites: string[]; unreadCount?: number; relatedOffers?: Offer[] };

export function OfferDetail({ offer, user, initialFavorites, unreadCount = 0, relatedOffers = [] }: Props) {
