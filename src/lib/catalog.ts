...
export type PlatformEntry = { store: OfferStore; platform: Platform; slug: string; label: string; description: string };
...
// Le vrai logo de chaque plateforme vient de src/lib/platform-logos.ts.
export const platforms: PlatformEntry[] = [
  { store: "Epic Games", platform: "PC", slug: "epic-games", label: "Epic Games", description: "Jeux complets offerts chaque semaine sur l'Epic Games Store." },
  { store: "Steam", platform: "PC", slug: "steam", label: "Steam", description: "DLC, week-ends gratuits et jeux à garder dans ta bibliothèque Steam." },
  { store: "PlayStation", platform: "PLAYSTATION", slug: "playstation", label: "PlayStation", description: "Items, essais et récompenses gratuites pour PS4 et PS5." },
  { store: "Xbox", platform: "XBOX", slug: "xbox", label: "Xbox", description: "Accès gratuits et récompenses pour la console et le PC Xbox." },
  { store: "Twitch", platform: "AUTRES", slug: "twitch", label: "Twitch Drops", description: "Récompenses à débloquer en regardant les streams partenaires." },
  { store: "Roblox", platform: "AUTRES", slug: "roblox", label: "Roblox", description: "Accessoires et objets de collection offerts par la communauté." },
  { store: "Prime Gaming", platform: "PC", slug: "prime-gaming", label: "Prime Gaming", description: "Jeux, contenus et skins inclus avec un abonnement Amazon Prime." },
];
