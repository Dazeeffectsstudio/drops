...
export type PlatformEntry = { store: OfferStore; slug: string; label: string; description: string; logo: string; color: AccentColor };
...
export const platforms: PlatformEntry[] = [
  { store: "Epic Games", slug: "epic-games", label: "Epic Games", description: "Jeux complets offerts chaque semaine sur l'Epic Games Store.", logo: "E", color: "lime" },
  { store: "Steam", slug: "steam", label: "Steam", description: "DLC, week-ends gratuits et jeux à garder dans ta bibliothèque Steam.", logo: "S", color: "orange" },
  { store: "PlayStation", slug: "playstation", label: "PlayStation", description: "Items, essais et récompenses gratuites pour PS4 et PS5.", logo: "PS", color: "blue" },
  { store: "Xbox", slug: "xbox", label: "Xbox", description: "Accès gratuits et récompenses pour la console et le PC Xbox.", logo: "X", color: "orange" },
  { store: "Twitch", slug: "twitch", label: "Twitch Drops", description: "Récompenses à débloquer en regardant les streams partenaires.", logo: "T", color: "violet" },
  { store: "Roblox", slug: "roblox", label: "Roblox", description: "Accessoires et objets de collection offerts par la communauté.", logo: "R", color: "blue" },
  { store: "Prime Gaming", slug: "prime-gaming", label: "Prime Gaming", description: "Jeux, contenus et skins inclus avec un abonnement Amazon Prime.", logo: "PG", color: "lime" },
];

// Toutes les catégories prévues au projet, même sans offre active pour l'instant.
export const categories: CategoryEntry[] = [
  { category: "JEUX", slug: "games", label: "Jeux", description: "Des jeux complets, temporairement ou définitivement gratuits." },
  ...
  { category: "WEEK-END GRATUIT", slug: "free-weekend", label: "Week-ends gratuits", description: "Des jeux accessibles gratuitement le temps d'un week-end." },
];
