    ...
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", background: "#10120f", color: "#f5f5ed", fontFamily: "sans-serif", padding: 70 }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", fontSize: 36, fontWeight: 900 }}>DROPS<span style={{ color: "#d4fc71" }}>.</span></div>
          <div style={{ display: "flex", fontSize: 24, color: "#d4fc71", fontWeight: 800, background: "#1b1e1a", padding: "10px 26px", borderRadius: 999 }}>{store}</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 28, marginTop: 36 }}>
            ...
            <div style={{ display: "flex", fontSize: 46, color: "#d4fc71", fontWeight: 900 }}>GRATUIT</div>
          </div>
        </div>
