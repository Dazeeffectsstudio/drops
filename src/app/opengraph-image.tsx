  ...
  return new ImageResponse(
    (
      <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", background: "#10120f", color: "#f5f5ed", fontFamily: "sans-serif", padding: 80 }}>
        <div style={{ display: "flex", alignItems: "center", fontSize: 26, color: "#d4fc71", fontWeight: 800, letterSpacing: 6, marginBottom: 24 }}>DON&apos;T PAY. JUST PLAY.</div>
        <div style={{ display: "flex", fontSize: 150, fontWeight: 900, lineHeight: 1 }}>DROPS<span style={{ color: "#d4fc71" }}>.</span></div>
